		...
		<div class="row">
			...
			<article class="col-sm-8 maincontent">
				<font class='toplink'>
					...
					<a href='../kendaraan/index.php?p=12&ida=<?php print $ida;?>&kb=<?php print $kd_brg;?>&na=<?php print $nup;?>' style='text-decoration: none'>Input Data Pemeliharaan</a>
				</font>
				...
				<table cellspacing="2" cellpadding="4" width="100%">
					...
					<form role="form" method="post" action="act_inppemeliharaan.php">
					<tr>
						<td colspan='2' height='40' valign='bottom'><font class='txttablecontent'><b>Input Data Pemeliharaan</b></font></td>
					</tr>
					<tr>
						<td width='120' valign='top'><font class='txttablecontent'>Jns Pemeliharaan</font></td>
						<td><font class='txttablecontent'>: <select name="jns_pemeliharaan">
					...
					<tr>
						...
						<input style="width:150px"  class="tcal" name="tgl_pemeliharaan" type="text" value="<?php print date('Y-m-d');?>" autofocus> </font></td>
					</tr>
					<tr>
						<td width='120' valign='top'><font class='txttablecontent'>Teknisi</font></td>
						<td><font class='txttablecontent'>: <input style="width: 300px" id="teknisi" name="teknisi" value="<?php print $val['teknisi'];?>"/></font></td>
					</tr>
					<tr>
						<td width='120' valign='top'><font class='txttablecontent'>Uraian Kegiatan</font></td>
						<td><font class='txttablecontent'>: <textarea name="uraian" style="width: 600px; height: 150px"></textarea></font></td>
					</tr>
					<tr>
						<td width='120' valign='top'><font class='txttablecontent'>Catatan</font></td>
						<td><font class='txttablecontent'>: <textarea name="catatan" style="width: 600px; height: 150px"></textarea></font></td>
					</tr>
					<tr>
						<td width='120' valign='top'><font class='txttablecontent'>Total Biaya</font></td>
						<td><font class='txttablecontent'>: <input style="width: 150px" id="biaya" name="biaya" value="<?php print $val['biaya'];?>"/></font></td>
					</tr>
					<tr>
						<td width='120' valign='top'><font class='txttablecontent'>Pem. Selanjutnya</font></td>
						<td><font class='txttablecontent'>: 
						<input style="width:150px"  class="tcal" name="next_pemeliharaan" type="text" value="<?php print $next_pemeliharaan;?>" autofocus> </font></td>
					</tr>
					<tr>
						<td width='120' valign='top'><font class='txttablecontent'>Kondisi saat ini</font></td>
						<td><font class='txttablecontent'>: <select name="kondisi">
					...
					<tr>
						<td colspan='2' height='40' valign='bottom'><font class='txttablecontent'><b>Riwayat Pemeliharaan</b></font></td>
					</tr>
					<?php
					include '../index_files/conndb3.php';
					$query="select * from tbl_pemeliharaan_aset where kd_brg='$kd_brg' and no_aset=$no_aset order by sysid desc";
					$result1=mysql_query($query,$conn3) or die('Error, query failed');
					$no_urut=1;
					while ($val1=mysql_fetch_array($result1)) {
					?>
					<tr>
						<td ><font class='txttablecontent'><?php print $no_urut++.'.  '.$val1['tgl_pemeliharaan'];?> : </font></td>
						<td ><font class='txttablecontent'><?php print $val1['jns_pemeliharaan'];?></font></td>
					</tr>
					<tr>
						<td ></td>
						<td ><font class='txttablecontent'>Teknisi : <?php print $val1['teknisi'];?></font></td>
					</tr>
					<tr>
						<td ></td>
						<td ><font class='txttablecontent'><b>Uraian</b><br><?php print $val1['uraian'];?></font></td>
					</tr>
					<tr>
						<td ></td>
						<td ><font class='txttablecontent'><b>Catatan</b><br><?php print $val1['catatan'];?></font></td>
					</tr>
					<tr>
						<td ></td>
						<td ><font class='txttablecontent'>Pemeliharaan Selanjutnya : <?php print $val1['next_pemeliharaan'];?></font></td>
					</tr>
					<?php };?>
